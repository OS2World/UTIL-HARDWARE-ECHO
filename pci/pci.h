...
extern struct pci_access *pci_alloc(void) PCI_ABI;
extern void pci_init(struct pci_access *) PCI_ABI;
extern void pci_cleanup(struct pci_access *) PCI_ABI;
...
/* Do not use a file to parse the PCI ids but a memory buffer */
void pci_set_name_list_mem_buf (struct pci_access *a, char *buf, int to_be_freed) PCI_ABI;
